...
export function initialFX() {
  ...
  // Ensure hidden elements are visible for splitting but starts with zero opacity to avoid ghosting
  document.querySelectorAll(".landing-h2-info-1, .landing-h2-2").forEach(el => {
